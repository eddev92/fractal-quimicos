...
export default class TabPanelComponent extends React.Component {
        ...
        console.log(listServices)
           ...
           return (
            <ul className="list-group">
                {(listServices.content1) && <li className="list-group-item list-group-item-warning">{listServices.content1}{(panel15 === 'panel5') ? <div className="info" id="info" data-toggle="modal" data-target={`#${ID_MODAL_SERVICIO_01}`} onClick={this.openModal}><span><i className="material-icons" style={{margin: '3px', top: 0}}>new_releases</i></span></div> : null}</li>}
                {(listServices.content2) && <li className="list-group-item list-group-item-danger">{listServices.content2}</li>}
    ...
    renderItem(services, tabId) {
        console.log('services', services[1])
        console.log(tabId)
        switch(tabId) {
